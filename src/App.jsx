...
function App() {
  ...
  const character = params.get("name") || 'gavin';



  const modelMap = {
    gavin: {
      body: "./assets/gavin_body.glb",
      head: "./assets/gavin_Face.glb",
      animations: "./assets/gavin_animations.glb",
      audio: "./assets/audio/preview.mp3",
      key: "gavin"

    },
    malika: {
      body: "./assets/malika_body.glb",
      head: "./assets/malika_head.glb",
      animations: "./assets/malika_animations.glb",
      audio: "./assets/audio/laugh_audio.mp3",
      key: "malika"
    }
  }
    ...
    if (isIframe) {
      if (!expectedParentOrigin) {
        ...
        const threeModule = new ThreejsModule({
          ...
          setSpeakStates,
          setAudioReady,
          appData: modelMap?.[character] || modelMap.gavin,
        })
        ...
        >
          {
            ...
            <button
              ...
              onClick={() => {
                threeModuleRef.current.playAction(1);
              }}
            >
              Play Action</button>
          }
